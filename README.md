# PP · IPERC multimétodo

Aplicación web de La Movida SST Plus para identificación de peligros y valoración de riesgos.

## Flujo técnico

Peligro → Exposición → Evento → Consecuencia → Riesgo → Controles → Riesgo residual.
...
- NT-04-2023 y COVENIN 4004:2000 cuando corresponda al contexto venezolano.
